    ...
    <div class="dashboard-container">
      ...
      <section class="advisees-section">
        ...
        <div class="search-container">
          <input type="text" v-model="searchQuery" placeholder="Search advisees by name..." class="search-input" />
        </div>
        <table class="advisees-table">
          ...
          <tbody>
            <tr v-for="(student, index) in filteredAdvisees" :key="student.matric_no"
              :class="{ atRisk: student.gpa < 2.0 }">
              <td>{{ index + 1 }}</td>
